                ...
                <div class="row">
                    <div class="sectionPan panel panel-default col-md-7 shadow">
                        <div class="panel-body">
                            ...
                            <div class="row form-group" onmouseover="displayExample('essay1')">
                                <div class="col-md-12">
                            ...
                            <div class="row form-group" onmouseover="displayExample('essay2')">
                                <div class="col-md-12">
                                    <p style="white-space: pre-line;" class="large-label col-md-12">
...
<script>
    function displayExample(dom) {
        ...
        var exampleText = '...';
        if (dom == 'essay1') {
            exampleHelpText = '我們在找尋申請者過去有無領導他人達成目標的證據。由於在學校當「老師」，同時也是在擔任一個領導者的角色，你不只要帶領學生在學習方面及各方面有所提升，TFT也鼓勵你去思考，在學校及廣義的社區中，你如何能造成系統性的改變。';
            exampleText = '';
        }
         if (dom == 'essay2') {
            exampleHelpText = '我們要看見你過去敢於承諾，遇挑戰時能堅持不懈。這是因為參與TFT計劃本身就是一個重大的承諾，申請者不僅僅是要承諾成為一個兩年全職老師，為了在兩年之後你的學生及學校能造成一些影響或改變，遇到挑戰時我們希望你能努力不懈、持之以恆。';
            exampleText = '';
        }
